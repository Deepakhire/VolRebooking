...
Feature: OneWay_Inko
  ...
  Scenario Outline: <Testcase>
    ...
    And User clicks on "month_change_button"
...
#    And User handles Privacy Settings Page and proceeds with bookingss
#    And User opens the Amadeus Agate Picker
...
#    And User enters "Master_card_number" in "Master_Card_Number"
#    And User enters "Master_cardholder_name" in "Master_Cardholder_Name"
#    And User enters "Master_card_expiry" in "Master_Card_Expiry"
#    And User enters "Master_card_cvv" in "Master_Card_CVV"
#    And User enters "Master_billing_address" in "Master_Card_CVV"
